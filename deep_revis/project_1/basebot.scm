...
(time-to-impact 0 gravity) ;; -> 1.4142 (sqrt 2)
...
(time-to-height 0 gravity 0) ;; -> 1.4242 (sqrt 2)
(time-to-height 0 gravity 4.9) ;; -> 1
(time-to-height 0 gravity gravity) ;; 0
(time-to-height 4.9 gravity (+ gravity 1)) ;; -> .71428
